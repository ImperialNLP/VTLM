...
DUMP_PATH=/data/ozan/experiments/mmvc/mmvc_code/multi30k_from_scratch_v3_do0.4_isqrtw4k_small
...
python $TRAIN --beam_size 1 --exp_name nmt --dump_path ${DUMP_PATH} \
  ...
  --lgs 'en-de' --mt_step "en-de" --emb_dim 512 --n_layers 5 --n_heads 2 \
  --dropout '0.4' --attention_dropout '0.2' --gelu_activation true \
