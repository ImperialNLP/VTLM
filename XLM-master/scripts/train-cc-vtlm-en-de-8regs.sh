...
ipython -i train.py -- --exp_name vtlm_en_de_8regs_v3 --dump_path $DUMP_PATH --data_path $DATA_PATH \
  ...
  --num_of_regions 8 --only_vlm true --eval_vlm true --iter_seed 12345 --other_seed 12345 $@
