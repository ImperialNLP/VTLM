...
DUMP_PATH=/data/ozan/experiments/mmvc/mmvc_code/multi30k_mmt_ftune_v3
...
python $TRAIN --beam_size 1 --exp_name ${NAME} --dump_path ${DUMP_PATH} \
  ...
  --stopping_criterion 'valid_en-de_mmt_bleu,10' --validation_metrics 'valid_en-de_mmt_bleu' \
